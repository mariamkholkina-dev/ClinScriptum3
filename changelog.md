...
### Feat: Word add-in — навигация «назад/вперёд» по находкам в ревью

На странице детализации находки в режиме «Ревью находок» добавлена навигация к предыдущей/следующей находке (← Назад / Вперёд →) со счётчиком «N / M», работающая по текущему отфильтрованному списку (severity / статус / ложное срабатывание). Кнопки блокируются на границах. Требует rebuild word-addin.
