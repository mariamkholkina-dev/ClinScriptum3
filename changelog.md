...
- **Навигация к месту в документе**: при открытии карточки — автопереход к первому месту находки; цитаты кликабельны (переход к конкретному месту, текущее подсвечено); кнопка «Перейти в документе» циклически перебирает места (1↔2) со счётчиком «1/2».
